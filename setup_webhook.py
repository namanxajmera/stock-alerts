...
def setup_webhook() -> bool:
    ...
    try:
        ...
        if result.get("ok"):
            ...
            print(
                f"❌ Error setting webhook: {result.get('description', 'Unknown error')}"
            )
            return False
    ...
    try:
        ...
        if info.get("ok"):
            ...
            print(
                f"   Has Secret: {'Yes' if webhook_info.get('has_custom_certificate') or secret_token else 'No'}"
            )
...
def remove_webhook() -> bool:
    ...
    try:
        ...
        if result.get("ok"):
            ...
            print(
                f"❌ Error removing webhook: {result.get('description', 'Unknown error')}"
            )
            return False
...
def check_webhook() -> bool:
    ...
    try:
        ...
        if result.get("ok"):
            ...
            print(
                f"   Has Secret Token: {'Yes' if info.get('has_custom_certificate') else 'Unknown'}"
            )
            ...
            if info.get("last_error_date"):
                ...
                print(
                    f"   Last Error Message: {info.get('last_error_message', 'Unknown')}"
                )
            else:
            ...
            print(
                f"❌ Error checking webhook: {result.get('description', 'Unknown error')}"
            )
            return False
